...
tape('implicit checkout', function (t) {
  ...
  db.put('/a', '2', function (err) {
    ...
    collect(rs, function (err, actual) {
      ...
      t.equals(actual[0].values.length, 1)
      t.equals(actual[0].values[0].value, '2')
      t.end()
    })
  })
})
    ...
    db.put('/a/foo', 'quux', function (err) {
      ...
      db.put('/a/bar', 'baz', function (err) {
        ...
        collect(rs, function (err, actual) {
          ...
          t.equals(actual[0].values.length, 1)
          t.equals(actual[0].values[0].value, 'baz')
          t.equals(actual[1].type, 'put')
          t.equals(actual[1].name, '/a/foo')
          t.equals(actual[1].values.length, 1)
          t.equals(actual[1].values[0].value, 'quux')
          t.end()
        })
      })
    })
      ...
      db.snapshot(function (err, co2) {
        ...
        db.put('/a/bar', 'baz', function (err) {
          ...
          collect(rs, function (err, actual) {
            ...
            t.equals(actual[0].values.length, 1)
            t.equals(actual[0].values[0].value, 'quux')
            t.end()
          })
        })
      })
      ...
      db.put('/a', '2', function (err) {
        ...
        db.put('/b', '17', function (err) {
          ...
          collect(rs, function (err, actual) {
            ...
            t.equals(actual[0].name, '/a')
            t.equals(actual[0].values.length, 1)
            t.equals(actual[0].values[0].value, '1')
            t.equals(actual[1].type, 'put')
            t.equals(actual[1].name, '/a')
            t.equals(actual[1].values.length, 1)
            t.equals(actual[1].values[0].value, '2')
            t.end()
          })
        })
      })
      ...
      db.put('/a', '2', function (err) {
        ...
        db.put('/b', '17', function (err) {
          ...
          collect(rs, function (err, actual) {
            ...
            t.equals(actual[0].values.length, 1)
            t.equals(actual[0].values[0].value, '17')
            t.equals(actual[1].type, 'del')
            t.equals(actual[1].name, '/a')
            t.equals(actual[1].values.length, 1)
            t.equals(actual[1].values[0].value, '1')
            t.equals(actual[2].type, 'put')
            t.equals(actual[2].name, '/a')
            t.equals(actual[2].values.length, 1)
            t.equals(actual[2].values[0].value, '2')
            t.end()
          })
        })
      })
    ...
    db.snapshot(function (err, co) {
      ...
      db.put('/a/d/r', '3', function (err) {
        ...
        collect(rs, function (err, actual) {
          ...
          t.equals(actual[1].values.length, 1)
          t.equals(actual[1].values[0].value, '3')
          t.end()
        })
      })
    })
  ...
  create.two(function (a, b) {
    ...
    function validate () {
      ...
      collect(rs, function (err, actual) {
        ...
        t.equals(actual[0].name, '/a')
        t.equals(actual[0].values.length, 1)
        t.equals(actual[0].values[0].value, 'a')
        t.end()
      })
    }
  })
  ...
  create.two(function (a, b) {
    ...
    function validate () {
      ...
      collect(rs, function (err, actual) {
        ...
        t.equals(actual[0].type, 'put')
        t.equals(actual[0].name, '/a')
        t.equals(actual[0].values.length, 2)
        t.equals(actual[0].values[0].value, 'b')
        t.equals(actual[0].values[1].value, 'a')
        t.end()
      })
    }
  })
